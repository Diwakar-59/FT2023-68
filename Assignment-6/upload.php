    ...
    <div class="container">
      <div class="contents">
        ...
        if ($uploadOk != 0) {
          ...
          echo "<h3>Your Phone Number: $phone_number has been <span>HACKED!!</span></h3>";
          $validEmail = $email_api;
          if ($validEmail == true) {
            echo "<h3 id='cgreen'>Your email <span>$email</span> is valid!!</h3>";
          } else {
            echo "The email <span>$email</span> is <span>invalid!!</span>";
          }
        ...
        // Defining session variables to access in pdf file. 
        $_SESSION['img'] = $img;
        $_SESSION['fullname'] = $full_name;
        $_SESSION['phone'] = $phone_number;
        $_SESSION['email'] = $email;
        $_SESSION['sub_info'] = $sub_info;
